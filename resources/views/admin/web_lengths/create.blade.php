        ...
        <div class="col-lg-12">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title"> ایجاد  </h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{route('admin.web_lengths.store')}}">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="any" name="distributive_web_length" class="form-control" id="distributive_web_length" placeholder="مجموع طول شبکه توزیعی را وارد کنید" value="{{old('distributive_web_length')}}">
                        </div>
                        <div class="form-group">
                            <label for="transitive_web_length" class=" control-label">طول شبکه انتقالی</label>
                            <input type="number" step="any" name="transitive_web_length" class="form-control" id="transitive_web_length" placeholder="مجموع طول شبکه انتقالی را وارد کنید" value="{{old('transitive_web_length')}}">
                        </div>
                    </div>
                    <!-- /.card-body -->
