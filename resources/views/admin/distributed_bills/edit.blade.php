        ...
        <div class="col-lg-12">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">فرم ویرایش تعداد میتر خوان ها </h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{route('admin.distributed_bills.update',['distributed_bill'=>$distributedBill->id])}}">
                    @csrf
                    @method('PATCH')
                    <div class="card-body">
                       @include('admin.zone_pz_province.zone_pz_province_edit')
                        <div class="form-group">
                            <div class="row">
                                ...
                                <input type="number" name="total_distributed" class="form-control" id="total_distributed" placeholder="تعداد بل های توزیع شده را وارد کنید" value="{{old('total_distributed',$distributedBill->total_distributed)}}">
                            </div>
                        </div>
