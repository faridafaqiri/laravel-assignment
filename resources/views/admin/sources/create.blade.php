...
' , ['title' => 'ثبت منابع'])
    @slot('breadcrumb')
        ...
        <li class="breadcrumb-item active">ثبت  منابع</li>
    @endslot
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title"> ثبت منابع </h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{route('admin.sources.store')}}">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="total_source" class="form-control" id="total_source" placeholder="مقدار منابع را وارد کنید" value="{{old('total_source')}}">
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="total_active" class="form-control" id="total_active" placeholder="تعداد منابع فعال را وارد کنید" value="{{old('total_active')}}">
                                </div>
                                <div class="col-md-6">
                                    <label for="total_pumps" class=" control-label">تعداد پمپ ها</label>
                                    <input type="number" name="total_pumps" class="form-control" id="total_pumps" placeholder=" مقدار پمپ ها را وارد کنید" value="{{old('total_pumps')}}">
                                </div>
                            </div>
                        </div>
