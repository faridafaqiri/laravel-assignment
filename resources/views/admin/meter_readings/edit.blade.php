        ...
        <div class="col-lg-12">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title"> ویرایش  میتر خوانی ها </h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{route('admin.meter_readings.update',['meter_reading'=>$meterReading->id])}}">
                    @csrf
                    @method('PATCH')
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="total_read" class="form-control" id="total_read" placeholder="تعداد میتر های خوانده شده را وارد کنید" value="{{old('total_read',$meterReading->total_read)}}">
                                </div>
                                <div class="col-md-6">
