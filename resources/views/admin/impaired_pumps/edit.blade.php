...
' , ['title' => 'پمپ های خراب شده'])
    @slot('breadcrumb')
        ...
        <li class="breadcrumb-item active">ویرایش پمپ های خراب شده</li>
    @endslot
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title"> ویرایش پمپ های خراب شده</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{route('admin.impaired_pumps.update',['impaired_pump'=>$impairedPump->id])}}">
                    @csrf
                    @method('PATCH')
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" id="total_impaired" name="total_impaired" placeholder="تعداد پمپ های خراب شده را وارد کنید." value="{{old('total_impaired',$impairedPump->total_impaired)}}" class="form-control">
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <textarea name="reason" id="reason" cols="30" rows="5" placeholder="مطلب مورد نظر خود را وارد کنید" class="form-control">{{old('reason',$impairedPump->reason)}}</textarea>
                            </div>
