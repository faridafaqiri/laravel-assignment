        ...
        <div class="col-lg-12">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title"> ثبت آب های توزیع شده </h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{route('admin.water_distributions.store')}}">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <input type="number" step="any" name="water_distributed" class="form-control" id="water_distributed" placeholder="آب های توزیع شده را به متر مکعب وارد کنید" value="{{old('water_distributed')}}">
                            </div>
                        </div>
