    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card card-info">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{route('admin.water_tests.store')}}">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="count_of_instance" class="form-control" id="count_of_instance" placeholder="تعداد نمونه را وارد کنید" value="{{old('count_of_instance')}}">
                                </div>

                                <div class="col-md-6">
                                    <label for="parameters" class=" control-label">تعداد پارامتر ها</label>
                                    <input type="number" name="parameters" class="form-control" id="parameters" placeholder="تعداد پارامتر ها را وارد کنید" value="{{old('parameters')}}">
                                </div>
