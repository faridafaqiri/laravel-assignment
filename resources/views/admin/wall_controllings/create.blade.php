...
' , ['title' => 'ثبت وال کنترولینگ'])
    @slot('breadcrumb')
        <li class="breadcrumb-item"><a href="{{route('admin.')}}">پنل مدیریت</a></li>
        <li class="breadcrumb-item "><a href="{{route('admin.wall_controllings.index')}}">ثبت وال کنترولینگ</a></li>
        <li class="breadcrumb-item active">ثبت وال کنترولینگ</li>
    @endslot
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title"> ثبت وال کنترولینگ</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{route('admin.wall_controllings.store')}}">
                    @csrf
                    <div class="card-body">
