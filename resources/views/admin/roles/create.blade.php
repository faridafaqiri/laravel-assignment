                ...
                <form class="form-horizontal" method="post" action="{{route('admin.roles.store')}}">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" id="name" placeholder="نام مقام را وارد کنید" value="{{old('name')}}">
                        </div>
                        <div class="form-group">
                            <label for="label" class=" control-label">توضیح مقام</label>
                                <input type="text" name="label" class="form-control" id="label" placeholder="توضیح مقام را وارد کنید" value="{{old('label')}}">
                        </div>
