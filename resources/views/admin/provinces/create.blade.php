...
' , ['title' => 'ایجاد ولایت'])
    @slot('breadcrumb')
        ...
        <li class="breadcrumb-item active">ایجاد ولایت جدید</li>
    @endslot
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title"> ایجاد ولایت </h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{route('admin.provinces.store')}}">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            <label for="name" class=" control-label">نام ولایت</label>
                            <input type="text" name="name" class="form-control" id="name" placeholder="نام ولایت را وارد کنید" value="{{old('name')}}">
                        </div>
