...
' , ['title' => 'ثبت میترهای تعویض شده'])
    @slot('breadcrumb')
        ...
        <li class="breadcrumb-item "><a href="{{route('admin.meter_changes.index')}}">ثبت میترهای تعویض شده</a></li>
        <li class="breadcrumb-item active">ثبت میترهای تعویض شده</li>
    @endslot
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title"> ثبت میترهای تعویض شده </h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{route('admin.meter_changes.store')}}">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="total" class="form-control" id="total" placeholder="تعداد میتر های تعویض شده را وارد کنید" value="{{old('total')}}">
                                </div>
                                <div class="col-md-6">
                                    <label for="type" class=" control-label">نوع میتر های تعویض شده</label>
                                    <select name="type" id="type" class="form-control">
                                        <option value="productive">بالک میتر</option>
                                        <option value="transitive">میتر مشترک</option>
