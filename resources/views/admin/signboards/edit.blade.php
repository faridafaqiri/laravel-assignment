...
' , ['title' => ' لوحه ها'])
    @slot('breadcrumb')
        ...
        <li class="breadcrumb-item "><a href="{{route('admin.signboards.index')}}">ویرایش  لوحه ها</a></li>
        <li class="breadcrumb-item active">ویرایش لوحه ها</li>
    @endslot
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title"> ویرایش لوحه ها </h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{route('admin.signboards.update',['signboard'=>$signboard->id])}}">
                    @csrf
                    @method('PATCH')
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <input type="number" name="total" class="form-control" id="total" placeholder="تعداد لوحه ها را وارد کنید" value="{{old('total',$signboard->total)}}">
                            </div>
                        </div>
