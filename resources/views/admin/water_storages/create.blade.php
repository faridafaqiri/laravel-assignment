...
' , ['title' => 'ایجاد ذخیره آب'])
    @slot('breadcrumb')
        <li class="breadcrumb-item"><a href="{{route('admin.')}}">پنل مدیریت</a></li>
        <li class="breadcrumb-item "><a href="{{route('admin.water_storages.index')}}">همه ذخایر آب </a></li>
        <li class="breadcrumb-item active">ایجاد ذخایر آب</li>
    @endslot
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title">فرم ایجاد ذخایر آب </h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" action="{{route('admin.water_storages.store')}}">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" step="any" name="capacity" class="form-control" id="capacity" placeholder=" ظرفیت مخزن را به متر مکعب وارد کنید" value="{{old('capacity')}}">
                                </div>
                                <div class="col-md-6">
                                    <label for="storage_type">مواد ساخت ذخیره</label>
                                    <select class="form-control" name="storage_type" id="storage_type">
                                        <option value="0">کانکریتی</option>
                                        <option value="1">فلزی</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <select class="form-control" name="height_type" id="height_type">
                                        <option value="0">ارتفاعی</option>
                                        <option value="1">زمینی</option>
                                    </select>
                                </div>
                                <div class="col-md-6">
